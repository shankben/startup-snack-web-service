...
export default class WebServiceStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    */
    ...
    /**
    * A single-page React application hosted with Amplify
    *
    * @see: https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-amplify.App.html
    */
    const app = new SinglePageApp(this, "StartupSnack-WebService-SinglePageApp");

    new AwsCustomResource(this, `AmplifyBuild${new Date().toISOString()}`, {
      ...
      onCreate: {
        ...
        parameters: {
          appId: app.appId,
          jobType: "RELEASE",
          branchName: process.env.BRANCH ?? "single-page-app"
        }
      },
